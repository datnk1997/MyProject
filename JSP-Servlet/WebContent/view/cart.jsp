...
<head>
	<meta charset="utf-8">
		...
		<!--[if lt IE 9]>			
			...
			<script src="/Assignment-java4/themes/js/respond.min.js"></script>
		<![endif]-->
</head>
<body>
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="/Assignment-java4/themes/images/pageBanner.png" alt="New products" >
				...
				<form action="CartController">
					<div class="span9">					
						...
						<table class="table table-striped">
							...
							<tbody>
							<c:forEach items="${carts}" var="cartdetail">
								<tr>
									<td><input type="checkbox" value="${cartdetail.getCDid()}" name="CDid"></td>
									<td><img alt="" src="${cartdetail.product.getPicture()}"></a></td>
									<td>${cartdetail.product.getPname()}</td>
									<td>${cartdetail.getQuantity()}</td>
									<td>${cartdetail.product.getPrice()}</td>
									<td>${cartdetail.getTotal() }</td>
								</tr>	
						...
						<p class="buttons center">
							...
							<button class="btn btn-inverse" type="submit" id="checkout" name="action" value="checkout">Checkout</button>
						</p>					
					</div>
					</form>
				</div>
