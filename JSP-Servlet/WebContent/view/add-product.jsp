							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										...
										<form role="form" action="AddProductController">
											...
											<div class="form-group">
												<label>Tên Điện Thoại</label> <input class="form-control" type="text" name="Pname"/>
											</div>
											<div class="form-group">
												<label>Giá Tiền</label> <input class="form-control" name="Price" />
											</div>
											<div class="form-group">
												<label>Note</label>
											...
											<div class="form-group">
												<label>Ảnh</label> <input type="file" name="Picture"/>
											</div>
											<div class="form-group">
												<label>Độ Rộng Màn Hình</label> <input class="form-control"  name="Manhinh"/>
											</div>
											<div class="form-group">
												<label>Tên CPU</label> <input class="form-control" name="CPU" />
											</div>
											<div class="form-group">
												<label>Hệ Điều Hành</label> <input class="form-control" name="Hedieuhanh" />
											</div>
											<div class="form-group">
												<label>Ram</label> <input class="form-control" name="Ram" />
											</div>
											<div class="form-group">
												<label>Bộ Nhớ Trong</label> <input class="form-control" name="Bonhotrong"/>
											</div>
