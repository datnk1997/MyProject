...
<body>
	...
	<div id="wrapper" class="container">
		...
		<div class="flexslider">
			<ul class="slides">
				<li><img
					src="/Assignment-java4/themes/images/carousel/1.jpg" alt=""  height="100"/>
				</li>
					...
					<c:forEach items="${list}" var="list">
						<li class="span3">
							<div class="product-box">
								<a href="/Assignment-java4/product_detail?Pid=${list.getPid()}"><img
									alt="" src="${list.getPicture()}"></a><br /> <a
									href="/Assignment-java4/product_detail?Pid=${list.getPid()}"
									class="title">${list.getPname()}</a><br /> <a href="#"
									class="category">${list.getNote()}</a>
								<p class="/Assignment-java4/product_detail?Pid=${list.getPid()}">$
									${list.getPrice()}</p>
							</div>
						</li>
					</c:forEach>
